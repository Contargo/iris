...
public class TransportDescriptionExtenderUnitTest {
    ...
    public void withRoutingInformation() {
        ...
        assertThat(result.transportChain.get(0).co2.value, comparesEqualTo(new BigDecimal("22.6")));
        ...
        assertThat(result.transportChain.get(1).co2.value, comparesEqualTo(new BigDecimal("23.6")));
        ...
        assertThat(result.transportChain.get(2).co2.value, comparesEqualTo(new BigDecimal("23.6")));
    }
