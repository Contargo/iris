...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="content-title">
            <h2>
                <spring:message code="seaports.page.title"/>
            </h2>
        </div>
    </div>
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="content">
                ...
                <c:url value="/web/seaports/new" var="COMPLETE_CREATE_URL"/>
                ...
                <display:table name="seaports" class="table iris-table" uid="seaport" requestURI="${BASE_URL}">
                    ...
                    <spring:message code="seaport.enabled" var="label"/>
                    <display:column title="${label}" property="enabled" sortable="true"/>

                    <display:column class="table-buttons">

                        <a href="<c:url value="/web/seaports/${seaport.id}" />" class="btn btn-primary">
