...
public class Co2ServiceImplUnitTest {
    ...
    public void getEmissionExportOneWay() {
        ...
        // + 2*10,8 (co2 handling)
        // +10 (barge part)
        // + 10,8 (Umschlag "Direkttruck Oneway")
        // = 47.4

        BigDecimal co2 = sut.getEmission(route);
        assertThat(co2, comparesEqualTo(new BigDecimal("47.4")));
    }
    ...
    public void getEmissionRoundTrip() {
        ...
        when(co2PartBargeStrategyMock.getEmissionForRoutePart(bargePart1, IMPORT)).thenReturn(new BigDecimal("10"));
        when(co2PartBargeStrategyMock.getEmissionForRoutePart(bargePart2, IMPORT)).thenReturn(new BigDecimal("15"));
        when(co2PartTruckStrategyMock.getEmissionForRoutePart(truckPart1, IMPORT)).thenReturn(new BigDecimal("2"));
        when(co2PartTruckStrategyMock.getEmissionForRoutePart(truckPart2, IMPORT)).thenReturn(new BigDecimal("3"));
        ...
        BigDecimal co2 = sut.getEmission(route);
        assertThat(co2, comparesEqualTo(new BigDecimal("73.2")));
    }
    ...
    public void getEmissionDirectTruckExportOneWay() {
        ...
        assertThat(co2, comparesEqualTo(new BigDecimal("15.8")));
    }
