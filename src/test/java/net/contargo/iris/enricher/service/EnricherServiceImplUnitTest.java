...
/**
 * Unit test of {@link net.contargo.iris.enricher.service.EnricherServiceImpl}.
 *
...
public class EnricherServiceImplUnitTest {
    ...
    public void enrichOSRMFailure() throws CriticalEnricherException {
        ...
        doThrow(OSRMNonRoutableRouteException.class).when(routePartEnricherMock).enrich(any(RoutePart.class),
            any(EnricherContext.class));
    ...
    public void enrichCriticalEnricherException() throws CriticalEnricherException {
        ...
        doThrow(CriticalEnricherException.class).when(routePartEnricherMock).enrich(any(RoutePart.class),
            any(EnricherContext.class));
