...
public class Co2CalculatorUnitTest {
    ...
    public void testWater() {
        ...
        assertThat(water(new WaterParams(SCHELDE, EMPTY, UPSTREAM)), comparesEqualTo(new BigDecimal("35.00")));
        assertThat(water(new WaterParams(SCHELDE, FULL, DOWNSTREAM)), comparesEqualTo(new BigDecimal("36.00")));
        assertThat(water(new WaterParams(SCHELDE, EMPTY, DOWNSTREAM)), comparesEqualTo(new BigDecimal("10.80")));
