...
/**
 * Unit test for implementation of MainRunPartEnricher: {@link net.contargo.iris.enricher.service.MainRunPartEnricher}.
 *
...
public class MainRunPartEnricherUnitTest {
    ...
    private static final BigDecimal ELECTRICAL_DISTANCE = BigDecimal.ONE;
    private static final BigDecimal DIESEL_DISTANCE = BigDecimal.TEN;
    private static final BigDecimal DISTANCE = BigDecimal.ZERO;
    private static final BigDecimal DURATION = BigDecimal.TEN;
